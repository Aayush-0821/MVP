                    ...
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="hidden md:flex gap-6 lg:gap-8 text-gray-700 dark:text-gray-300 font-medium">
                            ...
                            {!user && (
                                <Link
                                    to="/login"
                                    className={`relative py-2 transition-all ${isActiveLink("/login")
                                            ? "text-[#4A70A9] dark:text-[#8FABD4] font-semibold"
                                            : "hover:text-[#4A70A9] dark:hover:text-[#8FABD4]"
                                        }`}
                                >
                                ...
                                <div className="relative">
                                    ...
                                    {showProfileMenu && (
                                        <div className="absolute right-0 mt-3 w-44 bg-white dark:bg-gray-800 rounded-lg shadow-xl p-3 text-sm border border-gray-200 dark:border-gray-700">
                                            <Link
                                                to="/dashboard"
                                                className="block p-2 hover:bg-[#8FABD4]/10 dark:hover:bg-[#8FABD4]/20 text-gray-900 dark:text-white rounded transition-colors"
                                            ...
                                            <button
                                                ...
                                                className="block w-full text-left p-2 hover:bg-red-500 hover:text-white text-gray-900 dark:text-white rounded mt-1 transition-colors"
                                            >
                                                Logout
                                            </button>
                                        </div>
                        ...
                        <div className="px-4 py-4 space-y-1">
                            ...
                            {navLinks.map((link) => (
                                <Link
                                    key={link.name}
                                    to={link.path}
                                    className={`block px-4 py-3 rounded-lg font-medium transition-all ${isActiveLink(link.path)
                                            ? "bg-gradient-to-r from-[#4A70A9]/10 to-[#8FABD4]/10 dark:from-[#4A70A9]/20 dark:to-[#8FABD4]/20 text-[#4A70A9] dark:text-[#8FABD4] border-l-4 border-[#4A70A9] dark:border-[#8FABD4] font-semibold"
                            ...
                            {user ? (
                                <>
                                    ...
                                    <Link
                                        to="/dashboard"
                                        className={`block px-4 py-3 rounded-lg font-medium transition-all ${isActiveLink("/dashboard")
                                                ? "bg-gradient-to-r from-[#4A70A9]/10 to-[#8FABD4]/10 dark:from-[#4A70A9]/20 dark:to-[#8FABD4]/20 text-[#4A70A9] dark:text-[#8FABD4] border-l-4 border-[#4A70A9] dark:border-[#8FABD4] font-semibold"
                                                : "text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800"
                                            }`}
                                        onClick={closeMobileMenu}
                                ...
                                <Link
                                    to="/login"
                                    className={`block px-4 py-3 rounded-lg text-center font-semibold transition-all ${isActiveLink("/login")
                                            ? "bg-gradient-to-r from-[#4A70A9] to-[#8FABD4] text-white shadow-lg"
                                            : "bg-gradient-to-r from-[#4A70A9]/90 to-[#8FABD4]/90 text-white hover:from-[#4A70A9] hover:to-[#8FABD4] shadow-md"
                                        }`}
                                    onClick={closeMobileMenu}
                                >
                                    Login
